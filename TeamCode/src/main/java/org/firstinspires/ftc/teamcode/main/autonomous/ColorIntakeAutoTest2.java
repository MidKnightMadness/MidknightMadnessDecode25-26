...
@Config
@Configurable
@Autonomous(name = "Color Intake Auto Test2", group = "Competition")
public class ColorIntakeAutoTest2 extends CommandOpMode {
    ...
    protected Command intake(){
        autoIntakeCommand = new AutoIntakeCommand2(spindexer, intake, intakePower, 8000, waitTime);
