    ...
    public void loop() {
        ...
        if(x1.update(gamepad1.x)) {
            ...
            if (result != null && result.isValid()) {
                ...
                megaTag1Pose = convertMetersToInch(megaTag1Pose);
                ...
                telemetry.addData("MT1Position(Buffered): ", megaTag1Pose.toString());
                telemetry.addData("MT2Pose: ", megaTag2Pose.toString());
                telemetry.addData("MT2Position(Buffered): ", megaTag1Pose.toString());
                ...
                for (LLResultTypes.FiducialResult f : list) {
                    ...
                    updatePanelsTelemetry(f, camPoseTarget, megaTag1Pose.getPosition());
...
//                    telemetry.addData("Corners",  f.getTargetCorners().toString());
    ...
    private void updatePanelsTelemetry(LLResultTypes.FiducialResult f, Position camPoseTarget, Position megaTag1){
