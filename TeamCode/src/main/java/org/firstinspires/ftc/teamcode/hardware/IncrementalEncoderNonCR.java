...
public class IncrementalEncoderNonCR extends EncoderBase<IncrementalEncoderNonCR> {
     ...
     */
    public IncrementalEncoderNonCR setDistancePerPulse(double distancePerPulse) {
    ...
    @Override
    public IncrementalEncoderNonCR setAngle(double angle) {
    ...
    public double getAngle() {
        return normalize(getAngleUnormalizedEncoder());
    }
    public double getAngleUnormalizedEncoder(){//normalized - 0 - 360
        return getRevolutions() * returnMaxForAngleUnit(angleUnit);
    }
    ...
    public double returnMaxForAngleUnit(AngleUnit angleUnit){
