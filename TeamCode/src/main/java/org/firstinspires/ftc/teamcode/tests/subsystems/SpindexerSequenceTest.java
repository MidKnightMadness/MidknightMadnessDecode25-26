...
@Configurable
@TeleOp(name = "SpindexerSequenceTest", group = "Spindexer")
@Disabled
public class SpindexerSequenceTest extends CommandOpMode {
    ...
    public void initialize() {
        ...
        gp1.getGamepadButton(GamepadKeys.Button.A).whenPressed(new SequentialCommandGroup(
                ...
                new SpindexerRawSequence(spindexer, SpindexerSpot.convertFromindex(new int[] {2, 1, 0, 2, 1, 2, 0, 2}), spotType, runMode, finishedTimeThreshold)
        ));
