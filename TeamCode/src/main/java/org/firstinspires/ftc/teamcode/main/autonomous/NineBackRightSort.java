...
public class NineBackRightSort extends BaseAuto {
    ...
    public static Pose intakeTwoPose = new Pose(100.5, 56, Math.toRadians(0));
    ...
    public static Pose intakeTwoEnd= new Pose(125, 56, Math.toRadians(0));
