...
//
//    public static double lowVel = 2;//target velocities
...
//         setFlywheelsPower(topVel, lowVel);
////        low.set(lowVel);
////        high.set(topVel);
//        updateTelem();
//    }
...
//    }
//
//    public boolean setFlywheelsPower(double topVel, double lowVel) {//assuming facing the shooting area
