...
public class AccelTest extends OpMode {
    ...
    public void updateTelemetry() {
        // Field plugin
        PanelsDrawing.drawRobot(pose);
        PanelsDrawing.drawPoseHistoryAL(accelHistory, accelHistoryLook);
        PanelsDrawing.drawPoseHistoryAL(decelHistory, decelHistoryLook);
