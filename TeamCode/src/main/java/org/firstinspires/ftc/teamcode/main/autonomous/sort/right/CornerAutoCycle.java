...
@Config
@Configurable
@Autonomous(name = "Corner Far Right Cycle", group = "Competition")
public class CornerAutoCycle extends BaseAuto {
    int startPipeline = 1;
    ...
    public static Pose cornerIntakeStartPose = new Pose(127, 10, Math.toRadians(0));
    public static Pose cornerIntakeEndPose = new Pose(132, 10, Math.toRadians(0));
