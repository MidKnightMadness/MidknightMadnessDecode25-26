...
public class NineCloseRightSort extends BaseAuto {
    ...
    public static Pose intakeCloseStartPose = new Pose(100, 84, Math.toRadians(0));
    public static Pose intakeMidStartPose = new Pose(100, 60, Math.toRadians(0));
    public static Pose intakeFarStartPose = new Pose(100, 36, Math.toRadians(0));
    public static Pose intakeCloseEndPose = new Pose(125, 84, Math.toRadians(0));
    public static Pose intakeMidEndPose = new Pose(125, 60, Math.toRadians(0));
    public static Pose intakeFarEndPose = new Pose(125, 36, Math.toRadians(0));
...
//                                new InstantCommand(() -> spindexer.getTurner2().setRunMode(CRServoEx2.RunMode.RawPower)),
    ...
    protected Command openGate(){
        return new SequentialCommandGroup(
                new SchedulePathTo(follower, openGatePose).setMaxPower(1.0),
