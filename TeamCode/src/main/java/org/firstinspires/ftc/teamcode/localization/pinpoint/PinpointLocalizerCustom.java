 ...
 */
public class PinpointLocalizerCustom implements Localizer {
     ...
     */
    public PinpointLocalizerCustom(HardwareMap map, PinpointConstants constants){ this(map, constants, new Pose());}
     ...
     */
    @SuppressLint("NewApi")
    public PinpointLocalizerCustom(HardwareMap map, PinpointConstants constants, Pose setStartPose){
    ...
    public void update() {
        ...
        pinpointPose = new Pose(currentPinpointPose.getX(), currentPinpointPose.getY(), normAngle(currentPinpointPose.getHeading()));
    }
